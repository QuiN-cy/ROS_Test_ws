...
if("TRUE" STREQUAL "TRUE")
  set(canopen_motor_node_SOURCE_PREFIX /home/student/test_ws/src/ros_packages/ros_canopen/canopen_motor_node)
  set(canopen_motor_node_DEVEL_PREFIX /home/student/test_ws/devel/.private/canopen_motor_node)
  ...
  set(canopen_motor_node_INSTALL_PREFIX /home/student/test_ws/install)
...
if(NOT "/home/student/test_ws/src/ros_packages/ros_canopen/canopen_motor_node/include;/usr/include " STREQUAL " ")
  set(canopen_motor_node_INCLUDE_DIRS "")
  set(_include_dirs "/home/student/test_ws/src/ros_packages/ros_canopen/canopen_motor_node/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'canopen_motor_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/test_ws/src/ros_packages/ros_canopen/canopen_motor_node/${idir}'.  ${_report}")
    endif()
    _list_append_unique(canopen_motor_node_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "canopen_motor;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/x86_64-linux-gnu/libmuparser.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/test_ws/devel/.private/canopen_motor_node/lib;/home/student/test_ws/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND canopen_motor_node_EXPORTED_TARGETS ${${canopen_motor_node_dep}_EXPORTED_TARGETS})
endforeach()
