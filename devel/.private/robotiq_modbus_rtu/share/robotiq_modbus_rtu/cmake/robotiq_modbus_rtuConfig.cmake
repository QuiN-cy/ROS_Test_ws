...
if("TRUE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX /home/student/test_ws/src/ros_packages/robotiq/robotiq_modbus_rtu)
  set(robotiq_modbus_rtu_DEVEL_PREFIX /home/student/test_ws/devel/.private/robotiq_modbus_rtu)
  ...
  set(robotiq_modbus_rtu_INSTALL_PREFIX /home/student/test_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/test_ws/src/ros_packages/robotiq/robotiq_modbus_rtu/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/test_ws/devel/.private/robotiq_modbus_rtu/lib;/home/student/test_ws/devel/lib;/opt/ros/melodic/lib)
