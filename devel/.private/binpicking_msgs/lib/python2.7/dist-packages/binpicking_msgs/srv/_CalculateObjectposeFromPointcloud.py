...
"""autogenerated by genpy from binpicking_msgs/CalculateObjectposeFromPointcloudRequest.msg. Do not edit."""
import sys
...
class CalculateObjectposeFromPointcloudRequest(genpy.Message):
  _md5sum = "56680b720436a8fbd002ea7abe6966e1"
  _type = "binpicking_msgs/CalculateObjectposeFromPointcloudRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CalculateObjectposeFromPointcloudRequest, self).__init__(*args, **kwds)
...
def _get_struct_B2I():
    ...
    return _struct_B2I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from binpicking_msgs/CalculateObjectposeFromPointcloudResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class CalculateObjectposeFromPointcloudResponse(genpy.Message):
  _md5sum = "daaaaf52565055c4a6ca92fcad485f9e"
  _type = "binpicking_msgs/CalculateObjectposeFromPointcloudResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CalculateObjectposeFromPointcloudResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_7dB().pack(_x.object_pose.pose.position.x, _x.object_pose.pose.position.y, _x.object_pose.pose.position.z, _x.object_pose.pose.orientation.x, _x.object_pose.pose.orientation.y, _x.object_pose.pose.orientation.z, _x.object_pose.pose.orientation.w, _x.success))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.object_pose.pose.position.x, _x.object_pose.pose.position.y, _x.object_pose.pose.position.z, _x.object_pose.pose.orientation.x, _x.object_pose.pose.orientation.y, _x.object_pose.pose.orientation.z, _x.object_pose.pose.orientation.w, _x.success,) = _get_struct_7dB().unpack(str[start:end])
...
def _get_struct_7dB():
    ...
    return _struct_7dB
class CalculateObjectposeFromPointcloud(object):
  _type          = 'binpicking_msgs/CalculateObjectposeFromPointcloud'
  _md5sum = '243cf703a4ab0240271683f44bc2d4c6'
  _request_class  = CalculateObjectposeFromPointcloudRequest
  _response_class = CalculateObjectposeFromPointcloudResponse
