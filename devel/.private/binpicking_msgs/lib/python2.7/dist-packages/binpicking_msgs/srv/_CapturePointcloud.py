...
"""autogenerated by genpy from binpicking_msgs/CapturePointcloudRequest.msg. Do not edit."""
import sys
...
class CapturePointcloudRequest(genpy.Message):
  _md5sum = "da6c21c6d030841e7157c3016b0292a3"
  _type = "binpicking_msgs/CapturePointcloudRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CapturePointcloudRequest, self).__init__(*args, **kwds)
...
def _get_struct_i():
    ...
    return _struct_i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from binpicking_msgs/CapturePointcloudResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class CapturePointcloudResponse(genpy.Message):
  _md5sum = "8a747b7f9874b666b9af2d1275575307"
  _type = "binpicking_msgs/CapturePointcloudResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CapturePointcloudResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2B().pack(_x.pointcloud.is_dense, _x.success))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pointcloud.is_dense, _x.success,) = _get_struct_2B().unpack(str[start:end])
...
class CapturePointcloud(object):
  _type          = 'binpicking_msgs/CapturePointcloud'
  _md5sum = '315ec3f0ae151d189c2cc77d1ed9084f'
  _request_class  = CapturePointcloudRequest
  _response_class = CapturePointcloudResponse
